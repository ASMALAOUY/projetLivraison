    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/dashboard" element={
          <PrivateRoute allowedRoles={['manager']}><DashboardPage /></PrivateRoute>
        }/>
        <Route path="/map" element={
          <PrivateRoute allowedRoles={['manager']}><LiveMapPage /></PrivateRoute>
        }/>
        <Route path="/orders" element={
          <PrivateRoute allowedRoles={['manager']}><OrdersPage /></PrivateRoute>
        }/>
        <Route path="/livreur" element={
          <PrivateRoute allowedRoles={['driver']}><LivreurPage /></PrivateRoute>
        }/>
        <Route path="/suivi" element={
          <PrivateRoute allowedRoles={['client']}><TrackingPage /></PrivateRoute>
        }/>
